...
class Vocab:
    def __init__(self, vocab_file, max_size):
        ...
        self.count = 4
        self.MASK = [UNKNOWN_TOKEN, PAD_TOKEN, START_DECODING, STOP_DECODING]
        self.unk_token_index = self.MASK.index(UNKNOWN_TOKEN)
        self.pad_token_index = self.MASK.index(PAD_TOKEN)
        self.start_token_index = self.MASK.index(START_DECODING)
        self.stop_token_index = self.MASK.index(STOP_DECODING)
